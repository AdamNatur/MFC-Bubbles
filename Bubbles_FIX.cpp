...
// Bubbles_FIX.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CBubblesFIXApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CBubblesFIXApp::OnAppAbout)
...
// Создание CBubblesFIXApp

CBubblesFIXApp::CBubblesFIXApp() noexcept
{
	...
	SetAppID(_T("BubblesFIX.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CBubblesFIXApp

CBubblesFIXApp theApp;


// Инициализация CBubblesFIXApp

BOOL CBubblesFIXApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CBubblesFIXDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CBubblesFIXView));
	if (!pDocTemplate)
		return FALSE;
...
int CBubblesFIXApp::ExitInstance()
{
...
// Обработчики сообщений CBubblesFIXApp
...
void CBubblesFIXApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
